...
export default async function CocViewPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-6 print:space-y-0">
      <div className="flex items-center justify-between sticky top-0 z-50 bg-zinc-950/80 backdrop-blur-xl py-4 -mx-8 px-8 border-b border-premium-border/50 mb-6 print:static print:bg-transparent print:border-none print:p-0 print:m-0">
